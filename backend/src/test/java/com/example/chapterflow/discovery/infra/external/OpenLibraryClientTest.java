package com.example.chapterflow.discovery.infra.external;
...
class OpenLibraryClientTest {
    ...
    void setUp() {
        ...
        openLibraryClient = new OpenLibraryClient(builder, "ChapterFlow-Test (test@example.com)");
    }
    ...
    void userAgent_ShouldBeSetInRequests() {
        mockServer.expect(requestTo(org.hamcrest.Matchers.startsWith("https://openlibrary.org/search.json")))
                .andExpect(header("User-Agent", "ChapterFlow-Test (test@example.com)"))
